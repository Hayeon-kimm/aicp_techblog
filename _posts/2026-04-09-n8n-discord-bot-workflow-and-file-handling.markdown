---
layout: post
title: "[09-04-2026] 사이버 노예 AI Agent 만들기 - (2) n8n 디스코드 봇 워크플로우 구축 및 파일 처리 기능 추가"
...
n8n 워크플로우를 생성하여 디스코드 채널에 자동 메시지를 전송하는 구조를 구축하고, 디스코드 봇의 파일 수신/전송 기능을 추가했어요. 또한 봇 간 멘션이 인식되지 않는 문제의 원인을 분석하고 해결 방안을 도출했어요.
...
추가로 n8n Discord Trigger 설정에서 봇 메시지 수신 옵션 확인이 필요해요.
