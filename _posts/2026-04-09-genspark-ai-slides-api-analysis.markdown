---
layout: post
title: "Genspark AI Slides API 구조 분석 및 HAR 파일 기반 리버스 엔지니어링"
...
Genspark AI Slides 서비스의 API 구조를 파악하기 위해 오픈소스 클론(open-genspark)을 분석하고, 실제 서비스의 네트워크 요청을 HAR 파일로 캡처하여 분석하는 방향을 검토했습니다.
